            ...
            <CardContent className="p-0">
              <div className="aspect-video w-full">
                <iframe
                  width="100%"
                  height="100%"
                  src="https://www.youtube.com/embed/TgKn23eAJFw"
                  title="Aula 1 Darkfy"
                  frameBorder="0"
              ...
              <div className="p-6 bg-[#141414]">
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                  Aprenda os conceitos iniciais e como dar os primeiros passos na plataforma para começar a criar seu projeto de canal dark.
                </p>
              </div>
            </CardContent>
          </Card>
        ...
        >
          <Card className="bg-[#141414] border-[#2A2A2A] overflow-hidden">
            <CardHeader className="pb-4 border-b border-[#2A2A2A] bg-[#0A0A0A]">
              <CardTitle className="text-xl flex items-center gap-2 text-[#7B2EFF]">
                <BookOpen className="w-6 h-6" />
                Aula 2: Como usar a ferramenta e vender
              </CardTitle>
            </CardHeader>
            <CardContent className="p-0">
              <div className="aspect-video w-full">
